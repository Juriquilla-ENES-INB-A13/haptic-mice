...
public void createGUI(){
  ...
  lbl_inside_time = new GLabel(this, 40, 80, 80, 20);
  ...
  fld_inside_time = new GTextField(this, 120, 80, 120, 30, G4P.SCROLLBARS_NONE);
  fld_inside_time.setOpaque(true);
  lblOpenDoor = new GLabel(this, 0, 50, 210, 20);
  lblOpenDoor.setTextAlign(GAlign.CENTER, GAlign.MIDDLE);
  lblOpenDoor.setText("Time between experiments (ms):");
  lblOpenDoor.setOpaque(false);
  fldTimeExperiments = new GTextField(this, 210, 50, 70, 20, G4P.SCROLLBARS_NONE);
  fldTimeExperiments.setOpaque(true);
