...
public void createGUI(){
  ...
  surface.setTitle("Haptic Mice - Stage 2b");
  ...
  fld_time = new GTextField(this, 180, 60, 110, 20, G4P.SCROLLBARS_NONE);
  fld_time.setOpaque(true);
  fld_door_time = new GTextField(this, 180, 140, 390, 20, G4P.SCROLLBARS_NONE);
  fld_door_time.setText("1000,5000,10000,15000,20000,25000,30000");
