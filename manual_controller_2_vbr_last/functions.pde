...
void setArduino(){
  ...
  btnVibrateHigh.setVisible(true);
  btnVibrationLow.setVisible(true);
  btn_start.setVisible(true);
  btn_feed.setVisible(true);
...
void addWindowInfo(){
  surface.setTitle("Manual Stage "+day()+"-"+month()+"-"+year()+" "+hour()+":"+minute()+":"+second()+ "  Iteration:"+iteration+ " OK:"+numOk+" Fail:"+numFail);
}
