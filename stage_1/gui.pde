...
public void createGUI(){
  ...
  lbl_fail_time = new GLabel(this, 290, 50, 140, 20);
  ...
  fld_close_door = new GTextField(this, 430, 50, 80, 20, G4P.SCROLLBARS_NONE);
  fld_close_door.setOpaque(true);
  btn_vibrate = new GButton(this, 290, 160, 80, 30);
