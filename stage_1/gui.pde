...
public void createGUI(){
  ...
  lbl_time_response = new GLabel(this, -70, 170, 200, 20);
  ...
  lbl_exp_name = new GLabel(this, -70, 300, 200, 20);
  ...
  fld_response_time = new GTextField(this, 130, 170, 110, 20, G4P.SCROLLBARS_NONE);
  fld_response_time.setOpaque(true);
  fld_repeats = new GTextField(this, 130, 210, 110, 20, G4P.SCROLLBARS_NONE);
  fld_repeats.setOpaque(true);
  fld_time_experiments = new GTextField(this, 130, 260, 110, 20, G4P.SCROLLBARS_NONE);
  fld_time_experiments.setOpaque(true);
  fld_name = new GTextField(this, 130, 300, 110, 20, G4P.SCROLLBARS_NONE);
  fld_name.setOpaque(true);
  btn_fill = new GButton(this, 20, 380, 80, 30);
  btn_fill.setText("Fill");
  btn_fill.setLocalColorScheme(GCScheme.GOLD_SCHEME);
  btn_fill.addEventHandler(this, "fill_click");
  btn_startstop = new GButton(this, 190, 380, 80, 30);
  btn_startstop.setText("Start");
  btn_startstop.setLocalColorScheme(GCScheme.GREEN_SCHEME);
  btn_startstop.addEventHandler(this, "startstop_click");
  btn_open = new GButton(this, 530, 380, 80, 30);
  btn_open.setText("Open...");
  btn_open.addEventHandler(this, "open_click");
  lbl_door_time = new GLabel(this, -30, 130, 160, 20);
  lbl_door_time.setTextAlign(GAlign.RIGHT, GAlign.MIDDLE);
  lbl_door_time.setText("Time to open door (ms)");
  lbl_door_time.setOpaque(false);
  fld_door_time = new GTextField(this, 130, 130, 110, 20, G4P.SCROLLBARS_NONE);
  fld_door_time.setOpaque(true);
  lbl_fail_time = new GLabel(this, 280, 120, 140, 20);
  lbl_fail_time.setTextAlign(GAlign.RIGHT, GAlign.MIDDLE);
  lbl_fail_time.setText("If fail, close door(ms):");
  lbl_fail_time.setOpaque(false);
  fld_close_door = new GTextField(this, 420, 120, 80, 20, G4P.SCROLLBARS_NONE);
  fld_close_door.setOpaque(true);
  btn_vibrate = new GButton(this, 285, 292, 80, 30);
  ...
  btn_feed = new GButton(this, 530, 290, 80, 30);
  ...
  lst_port.setItems(Serial.list(), 0);
