...
public void fillR_click(GButton source, GEvent event) { //_CODE_:btnFillR:969608:
thread("fillR");
} //_CODE_:btnFillR:969608:

public void feedR_clic(GButton source, GEvent event) { //_CODE_:btnFeedR:637905:
  thread("feedR");

} //_CODE_:btnFeedR:637905:
...
public void createGUI(){
  ...
  btn_fillL = new GButton(this, 340, 210, 80, 30);
  ...
  btn_feedL = new GButton(this, 340, 250, 80, 30);
  ...
  taLog = new GTextArea(this, 590, 20, 340, 370, G4P.SCROLLBARS_BOTH | G4P.SCROLLBARS_AUTOHIDE);
  taLog.setOpaque(true);
  sldProportion = new GCustomSlider(this, 300, 140, 270, 60, "grey_blue");
  sldProportion.setShowValue(true);
  sldProportion.setShowLimits(true);
  sldProportion.setLimits(0, 0, 90);
  sldProportion.setNumberFormat(G4P.INTEGER, 0);
  sldProportion.setOpaque(false);
  lblProportionLeft = new GLabel(this, 300, 120, 130, 20);
